// here i will create svg as a component
...
export const Linkedin = (props) => {
  return (
    ...
    >
      <path
        d="M23.154 0H1.845A1.845 1.845 0 0 0 0 1.845v21.31A1.846 1.846 0 0 0 1.845 25h21.31A1.845 1.845 0 0 0 25 23.154V1.845A1.845 1.845 0 0 0 23.154 0ZM7.451 21.297H3.693V9.357H7.45v11.94ZM5.57 7.703a2.158 2.158 0 1 1 2.17-2.156 2.126 2.126 0 0 1-2.17 2.156Zm15.737 13.604h-3.757v-6.522c0-1.924-.818-2.518-1.874-2.518-1.114 0-2.208.84-2.208 2.566v6.474H9.708V9.367h3.615v1.654h.048c.363-.735 1.634-1.99 3.573-1.99 2.098 0 4.363 1.245 4.363 4.89l-.001 7.386Z"
        fill={props.fill}
      />
    </svg>
  );
